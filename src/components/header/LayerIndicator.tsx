    ...
    <Show when={props.layerRanges().length > 0}>
      <div class="flex items-center gap-4">
        ...
        <div class="flex items-center gap-2">
          <span class="text-[1.2rem] text-blue-500 font-bold uppercase tracking-widest">L</span>
          <Show when={props.leftActive() && leftLayerInfo()}>
            <div class="flex items-center gap-1 px-2 py-1 rounded border border-blue-500 bg-blue-900/60">
              <span class="text-[0.8rem] font-black text-blue-300">{leftLayerInfo()!.name}</span>
        ...
        <div class="flex items-center gap-2">
          <span class="text-[1.2rem] text-green-500 font-bold uppercase tracking-widest">R</span>
          <Show when={props.rightActive() && rightLayerInfo()}>
            <div class="flex items-center gap-1 px-2 py-1 rounded border border-green-500 bg-green-900/60">
              <span class="text-[0.8rem] font-black text-green-300">{rightLayerInfo()!.name}</span>
